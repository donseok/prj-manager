...
export default function Layout() {
  return (
    <div className="flex h-screen flex-col overflow-hidden text-[color:var(--text-primary)]">
      ...
      <Header />
      <div className="relative z-0 flex flex-1 gap-6 overflow-hidden px-4 pt-4 pb-4 lg:px-6">
        <Sidebar />
        <main className="min-w-0 flex-1 overflow-y-auto">
          <div className="app-panel-strong min-h-full overflow-hidden p-0 md:p-7 lg:p-8">
            <Outlet />
          </div>
        </main>
        <ChatbotWidget />

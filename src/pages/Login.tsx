      ...
      <div className="relative hidden flex-1 items-center justify-center overflow-hidden lg:flex">
        <div className="app-panel-dark relative mx-10 flex h-[calc(100vh-5rem)] w-full max-w-xl flex-col items-center justify-center overflow-hidden rounded-[36px] p-12">
          ...
          <div className="relative text-center">
            <div className="mx-auto mb-8 w-fit shadow-[0_32px_64px_-32px_rgba(15,118,110,0.9)] rounded-[22px] overflow-hidden">
              <DKFlowLogo size={80} />
            </div>
      ...
      <div className="relative flex flex-1 items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 flex flex-col items-center gap-3 lg:hidden">
            <div className="shadow-[0_24px_45px_-26px_rgba(15,118,110,0.82)] rounded-[16px] overflow-hidden">
              <DKFlowLogo size={56} />
            </div>

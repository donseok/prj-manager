...
export const DEFAULT_WBS_COLUMNS: WBSColumn[] = [
  ...
  { id: 'planStart', header: '계획시작', width: 130, accessor: 'planStart', type: 'date', editable: true },
  { id: 'planEnd', header: '계획종료', width: 130, accessor: 'planEnd', type: 'date', editable: true },
  { id: 'planProgress', header: '계획공정율', width: 90, accessor: 'planProgress', type: 'progress', editable: true },
  { id: 'actualStart', header: '실적시작', width: 130, accessor: 'actualStart', type: 'date', editable: true },
  { id: 'actualEnd', header: '실적종료', width: 130, accessor: 'actualEnd', type: 'date', editable: true },
